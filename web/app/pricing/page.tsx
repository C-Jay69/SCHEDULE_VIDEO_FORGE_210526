...
const plans = [
  {
    ...
    highlight: false,
    features: [
      { text: "Creates 1 Video", included: true },
      { text: "1 Series", included: true },
      { text: "0 Motion Credits", included: true },
  ...
  },
  {
    ...
    highlight: false,
    features: [
      { text: "Posts 3 Times A Week", included: true, bold: true },
      { text: "1 Series", included: true },
      { text: "27 Motion Credits", included: true },
  ...
  },
  {
    ...
    highlight: true,
    features: [
      { text: "Posts Once A Day", included: true, bold: true },
      { text: "1 Series", included: true },
      { text: "62 Motion Credits", included: true },
      { text: "Auto-Post To Channel", included: true },
      { text: "Edit & Preview Videos", included: true },
      { text: "HD Video Resolution", included: true },
      { text: "Background Music", included: true },
  ...
  },
  {
    ...
    highlight: false,
    features: [
      { text: "Posts Twice A Day", included: true, bold: true },
      { text: "1 Series", included: true },
      { text: "124 Motion Credits", included: true },
      { text: "Auto-Post To Channel", included: true },
      { text: "Edit & Preview Videos", included: true },
      { text: "HD Video Resolution", included: true },
      { text: "Background Music", included: true },
