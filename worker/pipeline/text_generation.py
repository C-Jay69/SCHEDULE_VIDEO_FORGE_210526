...
class TextGenerationOrchestrator:
    ...
    Implements fallback logic: Local (Ollama) -> Cloud (OpenRouter).
    """
    def __init__(self):
        self.providers = []
        ...
        # 2. Fallback: OpenRouter (if API key exists)
...
async def generate_script(topic: str, tone: str = "engaging", style: str = "informational", duration_seconds: int = 60) -> str:
